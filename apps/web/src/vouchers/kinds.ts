...
export function docProfile(kind: SalesKind): DocProfile {
  ...
  return { ...side, invoice, order: !invoice, refLabel, refAria };
}
...
const ALL_TITLES: Readonly<Record<string, string>> = { ...KIND_TITLES, ...SALES_TITLES, stockJournal: 'Stock Journal' };
